...
export async function fetchIngredientStorageLifeRules() {
  return await restSelectAll(
    ...
    "select=ingredient_id,category,storage_approach,storage_location,default_days,condition_state,aliases,priority,notes,active&active=eq.true&order=priority.asc,ingredient_id.asc,storage_approach.asc"
  );
}
