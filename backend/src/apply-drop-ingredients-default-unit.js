...
if (!args.environment || !environmentTargets[args.environment]) {
  console.error("Usage: node backend/src/apply-drop-ingredients-default-unit.js --env dev");
...
console.log(JSON.stringify({
  ...
  dryRun: args.dryRun,
  defaultUnitColumnBefore: before,
  defaultUnitColumnAfter: after
}, null, 2));
...
async function hasDefaultUnitColumn() {
