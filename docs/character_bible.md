...
This document is the index for the TableUp Kitchen Universe / 冰箱救援队宇宙 and Fridge Jianghu character library. Full character bibles, prompts, and reference images live inside each `characters/<character_id>/` folder.

## Storage Standard

See `docs/character_asset_standard.md`.

## Character Index
* [Fridge Tianshi / 冰箱天师](../characters/fridge_tianshi/README.md): fridge guardian and inventory strategist.
* [Garlic Master / 大蒜爷](../characters/garlic_master/README.md): hidden elder and seasoning stabilizer.
* [Scallion Bro / 大葱哥](../characters/scallion_bro/README.md): market intelligence scout.
* [Ginger Sis / 姜姐](../characters/ginger_sis/README.md): warm practical aroma commander.
